<template>
  <div v-if="side === 'none'" v-on:click="onTapped" class="cursor-pointer">
  ...
  <div v-if="side === 'red'" v-on:click="onTapped" class="cursor-pointer">
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
  ...
  <div v-else-if="side === 'black'" v-on:click="onTapped" class="cursor-pointer">
    <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
      <circle cx="64" cy="64" r="64.0" fill="white" />
