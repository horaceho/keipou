<template>
  <div class="bg-white px-4 py-5 border-b border-gray-200 sm:px-6">
    <h3 class="text-lg leading-6 font-medium text-gray-900">SVGs</h3>
  </div>
  <div>
    <svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
      <circle cx="32" cy="32" r="30.0" fill="none" stroke="url(#gradient)" stroke-width="2" filter="url(#shadow)" />
      <defs>
